...
export const EQUIPMENT: EquipmentItem[] = [
  ...
  { id: 'dumbbell', name: 'Håndvægte', countable: true, def: 2, onByDefault: true, hint: 'Par eller enkelt' },
  { id: 'kettlebell', name: 'Kettlebells', countable: true, def: 2, onByDefault: true, hint: 'Svinger og bærer' },
  { id: 'barbell', name: 'Vægtstang', countable: true, def: 1, onByDefault: true, hint: 'Med skiver' },
  { id: 'rower', name: 'RowERG', machine: true, countable: true, def: 1, onByDefault: true, hint: 'Romaskine' },
  { id: 'skierg', name: 'SkiERG', machine: true, countable: true, def: 1, onByDefault: true, hint: 'Skimaskine' },
  { id: 'bikeerg', name: 'BikeERG', machine: true, countable: true, def: 1, onByDefault: true, hint: 'Cykelergometer' },
  ...
  { id: 'box', name: 'Box', countable: true, def: 1, onByDefault: true, hint: 'Plyobox' },
  { id: 'pullupbar', name: 'Pull-up bar', countable: true, def: 1, onByDefault: true, hint: 'Stang at hænge i' },
  { id: 'wallball', name: 'Wall ball', countable: true, def: 1, onByDefault: true, hint: 'Bold og mål' },
  { id: 'sandbag', name: 'Sandbag', countable: true, def: 1, onByDefault: true, hint: 'Træningssæk' },
  { id: 'rings', name: 'Ringe', countable: true, def: 1, onByDefault: false, hint: 'Gymnastikringe' },
  { id: 'jumprope', name: 'Sjippetov', countable: true, def: 2, onByDefault: false, hint: 'Single og double unders' },
  { id: 'band', name: 'Elastikker', countable: true, def: 2, onByDefault: false, hint: 'Assistance og mobilitet' },
  { id: 'airrunner', name: 'Air Runner', machine: true, countable: true, def: 1, onByDefault: false, hint: 'Kurvet løbebånd' },
  { id: 'run', name: 'Løb udenfor', countable: false, onByDefault: false, hint: 'Plads til at løbe ude' },
];
