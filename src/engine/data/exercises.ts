...
export const EXERCISES: Exercise[] = [
  ...
  E({ id: 'db_walking_lunge', grind: 'medium', name: 'Walking Lunge med håndvægte', cat: 'squat', eq: ['dumbbell'], lvl: 2, avoid: ['knee'], da: 'Håndvægte ved siden eller på skuldrene. Lodret overkrop.', fat: { legs: 3, grip: 2, core: 1 }, sec: 2.4, rep: [20, 40], load: { m: 2 * 22.5, f: 2 * 15 }, pair: true, sub: ['walking_lunge'], weight: 1.3 }),
  ...
  E({ id: 'db_front_rack_lunge', grind: 'medium', name: 'Front Rack Lunge', cat: 'squat', eq: ['dumbbell'], lvl: 2, da: 'Håndvægte på skuldrene, overkroppen lodret.', fat: { legs: 3, core: 2, shoulder: 1 }, sec: 3, rep: [16, 24], load: { m: 2 * 22.5, f: 2 * 15 }, pair: true, avoid: ['knee'], sub: ['db_reverse_lunge'], weight: 1.1 }),
  E({ id: 'box_jump_over', grind: 'medium', name: 'Box Jump Over', cat: 'squat', eq: ['box'], lvl: 2, avoid: ['knee'], da: 'Op og over boksen. Stå helt op i toppen.', fat: { legs: 3, engine: 3, cns: 1 }, sec: 3.4, rep: [10, 24], sub: ['box_jump', 'box_step_over'], weight: 1.35 }),
  E({ id: 'box_jump', grind: 'medium', name: 'Box Jump', cat: 'squat', eq: ['box'], lvl: 2, avoid: ['knee'], da: 'Spring op, stå helt op, træd ned.', fat: { legs: 2, engine: 2, cns: 1 }, sec: 3, rep: [10, 20], sub: ['box_step_over'], weight: 1.15 }),
  ...
  E({ id: 'kb_american_swing', grind: 'medium', name: 'American Kettlebell Swing', cat: 'hinge', eq: ['kettlebell'], lvl: 3, tech: 3, avoid: ['back', 'shoulder'], da: 'Hele vejen over hovedet. Hoften driver, armene styrer.', fat: { hinge: 3, shoulder: 2, engine: 3 }, sec: 2, rep: [15, 30], load: { m: 24, f: 16 }, sub: ['kb_swing'], weight: 1 }),
  ...
  E({ id: 'dip', grind: 'high', name: 'Dips', cat: 'press', eq: ['rings', 'box'], lvl: 3, tech: 3, avoid: ['shoulder'], da: 'Skuldrene under albuerne i bunden, fuld strækning i toppen.', fat: { press: 3, shoulder: 2 }, sec: 2.5, rep: [6, 15], sub: ['push_up'], weight: 0.8 }),
  E({ id: 'hspu', grind: 'high', name: 'Handstand Push-up', cat: 'press', lvl: 4, tech: 5, elig: 'advanced', avoid: ['shoulder', 'wrist'], da: 'Håndstand mod væg, hovedet til gulvet, pres op.', fat: { press: 3, shoulder: 3, cns: 2 }, sec: 4, rep: [5, 12], sub: ['db_shoulder_press'], weight: 0.8 }),

  /* ---------- Træk ---------- */
  E({ id: 'pull_up', grind: 'high', name: 'Pull-ups', cat: 'pull', eq: ['pullupbar'], lvl: 3, tech: 3, avoid: ['shoulder'], da: 'Hagen over stangen, fuld strækning i bunden.', fat: { pull: 3, grip: 2, shoulder: 1 }, sec: 3, rep: [5, 14], sub: ['band_pull_up', 'ring_row'], weight: 1.4 }),
  E({ id: 'band_pull_up', grind: 'high', name: 'Band-assisted Pull-ups', cat: 'pull', eq: ['pullupbar', 'band'], lvl: 1, tech: 2, avoid: ['shoulder'], da: 'Elastik under foden eller knæet. Samme bane, mindre vægt.', fat: { pull: 2, grip: 2 }, sec: 2.8, rep: [8, 18], sub: ['ring_row'], weight: 1.1 }),
  E({ id: 'chest_to_bar', grind: 'high', name: 'Chest-to-Bar Pull-ups', cat: 'pull', eq: ['pullupbar'], lvl: 4, tech: 4, elig: 'advanced', avoid: ['shoulder'], da: 'Brystet rører stangen. Kip fra en spændt krop.', fat: { pull: 3, grip: 3, shoulder: 2 }, sec: 3, rep: [5, 12], sub: ['pull_up'], weight: 0.8 }),
  E({ id: 'jumping_pull_up', grind: 'high', name: 'Jumping Pull-up', cat: 'pull', eq: ['pullupbar', 'box'], accessory: true, da: 'Spring op, kontrolleret ned.', fat: { pull: 2, grip: 1, engine: 1 }, sec: 2, rep: [10, 20], sub: ['ring_row'], weight: 0.5 }),
  E({ id: 'ring_row', grind: 'high', name: 'Ring Row', cat: 'pull', eq: ['rings'], da: 'Krop lige, træk brystet til ringene. Sværhedsgrad = fodplacering.', fat: { pull: 2, core: 1 }, sec: 2.5, rep: [10, 20], sub: ['db_row'], weight: 0.8 }),
  E({ id: 'db_row', grind: 'high', name: 'Dumbbell Row', cat: 'pull', eq: ['dumbbell'], da: 'Én arm ad gangen, træk mod hoften.', fat: { pull: 2, grip: 1 }, sec: 2.5, rep: [10, 20], load: { m: 27.5, f: 17.5 }, sub: ['ring_row'], weight: 0.8 }),
  E({ id: 'barbell_row', grind: 'high', name: 'Barbell Row', cat: 'pull', eq: ['barbell'], lvl: 2, avoid: ['back'], da: 'Hinge frem, træk stangen til underste ribben.', fat: { pull: 3, hinge: 1, grip: 2 }, sec: 3, rep: [6, 12], load: { m: 70, f: 45 }, sub: ['db_row'], weight: 0.9 }),
  E({ id: 'toes_to_bar', grind: 'high', name: 'Toes-to-Bar', cat: 'pull', eq: ['pullupbar'], lvl: 3, tech: 4, elig: 'advanced', avoid: ['shoulder'], da: 'Tæerne til stangen, kontrolleret sving.', fat: { core: 3, grip: 3, shoulder: 1 }, sec: 2.5, rep: [8, 15], sub: ['hanging_knee_raise', 'sit_up'], weight: 1 }),
  E({ id: 'hanging_knee_raise', grind: 'high', name: 'Hanging Knee Raise', cat: 'pull', eq: ['pullupbar'], lvl: 2, accessory: true, da: 'Knæene op over hoftehøjde, uden at gynge.', fat: { core: 2, grip: 2 }, sec: 2.5, rep: [10, 18], sub: ['sit_up'], weight: 0.4 }),

  /* ---------- Hele kroppen ---------- */
  E({ id: 'thruster', grind: 'high', name: 'Thrusters', cat: 'fullbody', eq: ['barbell'], lvl: 3, tech: 3, avoid: ['shoulder', 'knee'], da: 'Front squat direkte videre til pres over hovedet i én bevægelse.', fat: { legs: 3, shoulder: 3, engine: 3, press: 2 }, sec: 3, rep: [9, 21], load: { m: 43, f: 30 }, sub: ['db_thruster'], weight: 1.4 }),
  ...
  E({ id: 'burpee_box_jump_over', grind: 'medium', name: 'Burpee Box Jump-over', cat: 'fullbody', eq: ['box'], lvl: 3, avoid: ['knee'], da: 'Burpee og over boksen — enhver måde tæller.', fat: { engine: 3, legs: 2 }, sec: 5, rep: [8, 16], sub: ['burpee'], weight: 1.2 }),
  E({ id: 'burpee_pull_up', grind: 'medium', name: 'Burpee Pull-up', cat: 'fullbody', eq: ['pullupbar'], lvl: 3, avoid: ['shoulder'], da: 'Burpee under stangen, spring direkte op i pull-up.', fat: { engine: 3, pull: 3, grip: 2 }, sec: 5.5, rep: [6, 14], sub: ['burpee'], weight: 1 }),
  ...
  E({ id: 'devil_press', grind: 'high', name: 'Devil Press', cat: 'fullbody', eq: ['dumbbell'], lvl: 3, avoid: ['shoulder', 'back'], da: 'Burpee med håndvægte og sving hele vejen op over hovedet.', fat: { engine: 3, shoulder: 3, hinge: 2 }, sec: 6, rep: [6, 16], load: { m: 2 * 22.5, f: 2 * 15 }, pair: true, sub: ['db_snatch'], weight: 1.3 }),
  E({ id: 'db_snatch', grind: 'medium', name: 'Dumbbell Snatch', cat: 'fullbody', eq: ['dumbbell'], lvl: 2, tech: 3, avoid: ['shoulder', 'back'], da: 'Fra gulv til over hovedet i én bevægelse, skiftevis arm.', fat: { hinge: 2, shoulder: 2, engine: 3, grip: 2 }, sec: 2.2, rep: [10, 24], load: { m: 22.5, f: 15 }, sub: ['kb_swing'], weight: 1.2 }),
  E({ id: 'sandbag_shoulder', grind: 'high', name: 'Sandbag to Shoulder', cat: 'fullbody', eq: ['sandbag'], lvl: 3, avoid: ['back'], da: 'Sandbag fra gulv til skulder, skiftevis side.', fat: { hinge: 3, grip: 2, engine: 2 }, sec: 5, rep: [6, 14], load: { m: 60, f: 40 }, sub: ['db_snatch'], weight: 1.1 }),
  ...
  /* ---------- Olympiske løft ---------- */
  E({ id: 'power_clean', grind: 'high', name: 'Power Clean', cat: 'oly', eq: ['barbell'], lvl: 3, tech: 4, avoid: ['back', 'wrist'], da: 'Eksplosivt træk, tag imod i front rack over parallel.', fat: { hinge: 3, cns: 3, legs: 2, grip: 2 }, sec: 4, rep: [2, 8], load: { m: 70, f: 47.5 }, sub: ['hang_power_clean', 'db_snatch'], weight: 1.3 }),
  E({ id: 'hang_power_clean', grind: 'high', name: 'Hang Power Clean', cat: 'oly', eq: ['barbell'], lvl: 2, tech: 4, avoid: ['back'], da: 'Start fra hængende position over knæet.', fat: { hinge: 2, cns: 3, legs: 2 }, sec: 3.5, rep: [3, 10], load: { m: 60, f: 42.5 }, sub: ['db_snatch'], weight: 1.35 }),
  E({ id: 'clean_and_jerk', grind: 'high', name: 'Clean & Jerk', cat: 'oly', eq: ['barbell'], lvl: 3, tech: 5, avoid: ['shoulder', 'back'], da: 'Clean til skulder, jerk over hovedet. Ét løft ad gangen.', fat: { hinge: 3, shoulder: 3, cns: 3, legs: 2 }, sec: 7, rep: [1, 6], load: { m: 70, f: 47.5 }, sub: ['power_clean'], weight: 1.2 }),
  E({ id: 'power_snatch', grind: 'high', name: 'Power Snatch', cat: 'oly', eq: ['barbell'], lvl: 4, tech: 5, elig: 'advanced', avoid: ['shoulder', 'back', 'wrist'], da: 'Fra gulv til over hovedet i ét træk, modtag over parallel.', fat: { hinge: 3, shoulder: 3, cns: 3 }, sec: 5, rep: [2, 6], load: { m: 50, f: 35 }, sub: ['power_clean', 'db_snatch'], weight: 0.8 }),
  E({ id: 'push_jerk', grind: 'high', name: 'Push Jerk', cat: 'oly', eq: ['barbell'], lvl: 3, tech: 4, avoid: ['shoulder'], da: 'Dip, driv, og dyk under stangen med låste arme.', fat: { shoulder: 3, legs: 1, cns: 3 }, sec: 3.5, rep: [2, 8], load: { m: 70, f: 47.5 }, sub: ['push_press'], weight: 1 }),
  ...
  E({ id: 'sled_pull', grind: 'medium', name: 'Sled Pull', cat: 'carry', eq: ['sled'], unit: 'm', lvl: 2, avoid: ['back'], da: 'Lav position, træk hånd over hånd eller gå baglæns i selen.', fat: { legs: 3, pull: 3, grip: 3, engine: 3 }, sec: 2, rep: [20, 60], load: { m: 88, f: 66 }, sub: ['sled_push'], weight: 1.25 }),
  ...
  E({ id: 'wu_plate_squat', name: 'Vægtskive Squat', cat: 'warmup', eq: ['barbell'], da: 'Hold en vægtskive ved brystet, dyb squat.', warmupCue: 'Let skive — 5–10 kg er rigeligt. Brystet højt, hælene i gulvet.', primes: ['squat', 'core'], fat: { legs: 1, core: 1 }, sec: 2.6, rep: [10, 18], weight: 1.1 }),
  E({ id: 'wu_plate_devil_press', name: 'Vægtskive Devil Press', cat: 'warmup', eq: ['barbell'], da: 'Burpee, og sving vægtskiven op over hovedet.', warmupCue: 'Let skive. Fokus på rytme, ikke fart.', primes: ['fullbody', 'press', 'hinge'], fat: { engine: 1, shoulder: 1, hinge: 1 }, sec: 5, rep: [6, 12], weight: 1.15 }),
  E({ id: 'wu_plate_russian_twist', name: 'Russian Twist med vægtskive', cat: 'warmup', eq: ['barbell'], da: 'Sid med løftede fødder, drej vægtskiven fra side til side.', warmupCue: 'Kontrolleret tempo — det er opvarmning, ikke et arbejdssæt.', primes: ['core'], fat: { core: 1 }, sec: 2, rep: [16, 30], weight: 1 }),
